    ...
    return (
        <div className="bg-[#111] rounded-lg p-4 border border-gray-800 shadow-inner">
            <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-white font-mono text-sm">V.E.R.A.</span>
                <span className={`w-2 h-2 rounded-full ${isTyping ? 'bg-purple-400 animate-pulse' : 'bg-gray-600'}`} />
            </div>
            ...
            <div className="flex justify-center mb-4">
                <motion.div
                    className={`w-16 h-16 rounded-full border-2 flex items-center justify-center
                     ${displayedMessage ? getTypeColor(displayedMessage.type) : 'border-purple-500'}`}
                    animate={{
                        scale: isTyping ? [1, 1.05, 1] : 1,
                        boxShadow: isTyping
                            ? ['0 0 10px rgba(147, 51, 234, 0.5)', '0 0 20px rgba(147, 51, 234, 0.8)', '0 0 10px rgba(147, 51, 234, 0.5)']
            ...
            {/* Message area - overflow-visible and padding prevent first-letter clipping */}
            <div className="min-h-[60px] text-xs font-mono text-gray-300 overflow-visible pl-1">
